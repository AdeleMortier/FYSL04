...
\section{Repérage des paradigmes}
	...
	\subsection{Diaphore}
		La ``fonction diaphorique [...] caractérise tout paratexte qui reprend sous forme condensée un fragment du texte'' \cite{Peraya1994}. Concrètement, une diaphore est soit une anaphore, soit une cataphore du léxème à définir ou d'un terme qui lui fait référence.\\
		\subsubsection{Anaphores lexicales/grammaticales}
			...
			\begin{center}
				...
				\begin{minipage}{0.7\textwidth}
					``l'astre'' (l.16, l.27) \\
					``Ce nuage'' (l.17) \\
					``notre étoile'' (l.41, l.43, l.46)
				\end{minipage}
			\end{center}
			On voit de nouveau que les articles (définis, démonstratifs, possessifs) jouent un rôle dans la détection de l'anaphore. En particulier, l'article possessif ``notre'' renvoie à la communauté des lecteurs et souligne que l'étoile dont il est question 
